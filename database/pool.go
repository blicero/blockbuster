// /home/krylon/go/src/github.com/blicero/blockbuster/database/pool.go
// -*- mode: go; coding: utf-8; -*-
// Created on 07. 08. 2021 by Benjamin Walkenhorst
// (c) 2021 Benjamin Walkenhorst
// Time-stamp: <2021-08-07 19:30:14 krylon>
//
// This file implements a primitive database connetion pool.
// AFAIK, for Go's database API is supposed to handle connection
// pooling transparently, so only a single connection object
// is needed, but I found that with SQLite this is not the case,
